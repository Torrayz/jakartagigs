...
@section('title', $highlight->title . ' - JakartaGigsInfo')
...
<section class="section">
    <div class="article-grid" style="display: grid; grid-template-columns: 2fr 1fr; gap: 3rem; max-width: 1200px; margin: 0 auto;">
        <!-- Main Article -->
        <article>
            <div class="card-category" style="margin-bottom: 1rem;">HIGHLIGHT</div>
            
            <h1 style="font-size: 2.5rem; margin-bottom: 1rem; color: #fff; line-height: 1.2;">{{ $highlight->title }}</h1>
            ...
            <div class="card-meta" style="margin-bottom: 2rem; font-size: 1rem;">
                ...
                <span><i class="fas fa-eye"></i> {{ number_format($highlight->views) }} views</span>
            </div>
        ...
        <aside>
            <div style="position: sticky; top: 2rem;">
                <h3 style="color: #f59e0b; margin-bottom: 1.5rem; font-size: 1.5rem;">More Highlights</h3>
                
                @if($relatedHighlights->count() > 0)
                    <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                        @foreach($relatedHighlights as $related)
                        <div class="card" style="background: rgba(245, 158, 11, 0.05); border: 1px solid rgba(245, 158, 11, 0.2);">
                            ...
                            <div class="card-content" style="padding: 1rem;">
                                <h4 style="color: #fff; font-size: 1rem; margin-bottom: 0.5rem; line-height: 1.3;">
                                    <a href="{{ route('highlights.show', $related->slug) }}" style="color: inherit; text-decoration: none;">
                                        {{ $related->title }}
                                    </a>
                                </h4>
                                ...
                                <a href="{{ route('highlights.show', $related->slug) }}" style="color: #f59e0b; font-size: 0.9rem; text-decoration: none; font-weight: 600;">
                                    READ MORE
                                </a>
                            </div>
                        </div>
                ...
                <div style="text-align: right; margin-top: 1rem;">
                    <a href="{{ route('highlights') }}" style="color: #f59e0b; text-decoration: none; font-weight: 600;">
                        See All
                    </a>
                </div>
            </div>
